/*
CREATE MOCKS in   https://designer.mocky.io/
----------------------------------------------
...
export default function () {
    ...
    let response = http.get('https://run.mocky.io/v3/12ed7bf8-aef8-470b-9972-f2a62d722a40') // returns response
    ...
    const check2 = check(response, {
        'body size is 59 bytes :': (r) => r.body.length == 59,
    })
